...
- [**Getting Started**](GETTING_STARTED.md): Setup and run in 5 minutes.
- [**Codebase Overview**](docs/CODEBASE_OVERVIEW.md): High-level tour of folders and code.
- [**System Design**](docs/SYSTEM_DESIGN.md): Architecture diagram and detailed explanation.
- [**Search & Indexing System**](docs/SEARCH_AND_INDEXING.md): Deep dive into Hybrid Search.
- [**Google File Search Reference**](docs/google_file_search_reference.md): Original API docs.
